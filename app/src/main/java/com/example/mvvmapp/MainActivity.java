...
import com.example.mvvmapp.adapters.RecyclerAdapter;
import com.example.mvvmapp.models.NicePlace;
import com.example.mvvmapp.viewmodels.MainActivityViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initRecyclerView(){
        mAdapter = new RecyclerAdapter(MainActivity.this, mMainActivityViewModel.getNicePlaces().getValue());
